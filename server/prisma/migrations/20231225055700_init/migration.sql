...
-- CreateEnum
CREATE TYPE "ProjectCategory" AS ENUM ('UX_UI', 'WebDevelopment', 'MobileDevelopment', 'VideoGameCreation', 'Animation3D');
...
-- CreateEnum
CREATE TYPE "QueryStatus" AS ENUM ('open', 'pendingApproval', 'closed');
