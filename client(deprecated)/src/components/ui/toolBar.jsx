    ...
    <div className={cn(containerClasses)}>
      <section className={cn(innerSectionClasses)}>
        <div className='h-full w-full flex flex-col justify-center items-center gap-5 text-white '>
          <Link href={'/workspace'} className='cursor-pointer text-[34px]'>
            <FaBook />
          </Link>
          <Link href={'/user'} className='cursor-pointer text-[34px]'>
            <FaUser />
          </Link>
          <Link href={'/projects'} className='cursor-pointer text-[34px]'>
            <FaGithub />
          </Link>
          <Link href={'/login'} className='cursor-pointer text-[34px]'>
            <FaHome />
          </Link>
        </div>
      </section>
